...
STYLE_MAP = {
    ...
    "nebula": 13,
    "cobwebs": 14,
    "strange_attractor": 15,
    "flow_field": 16,
    "sacred_geometry": 17,
    "recursive_fractal": 18,
    "potter_tunnel": 19,
    "fractal_scale": 20,
    "neuro_vortex": 21,
    "ojascki": 22,
...
class SpiralsLayer:
    ...
    def _assemble_shader(common_path, styles_dir):
        ...
        dispatch_lines = [
            ...
            "    else if (u_style == 5)  result = style_vortex(p);",
            "    else if (u_style == 6)  result = style_dna(p);",
            "    else if (u_style == 7)  result = style_rose(p);",
            "    else if (u_style == 8)  result = style_moire(p);",
            "    else if (u_style == 9)  result = style_spirograph(p);",
            "    else if (u_style == 10) result = style_fermat(p);",
            "    else if (u_style == 11) result = style_superformula(p);",
            "    else if (u_style == 12) result = style_liminal(p);",
            "    else if (u_style == 13) result = style_nebula(p);",
            "    else if (u_style == 14) result = style_cobwebs(p);",
            "    else if (u_style == 15) result = style_strange_attractor(p);",
            "    else if (u_style == 16) result = style_flow_field(p);",
            "    else if (u_style == 17) result = style_sacred_geometry(p);",
            "    else if (u_style == 18) result = style_recursive_fractal(p);",
            "    else if (u_style == 19) result = style_potter_tunnel(p);",
            "    else if (u_style == 20) result = style_fractal_scale(p);",
            "    else if (u_style == 21) result = style_neuro_vortex(p);",
            "    else if (u_style == 22) result = style_ojascki(p);",
